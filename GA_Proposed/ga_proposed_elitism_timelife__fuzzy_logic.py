# -*- coding: utf-8 -*-
"""GA_Proposed_Elitism_TimeLife_ Fuzzy_Logic.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1I0VvTZDa_uF4PgZuisgPSdDo63pGtcBo
...
def averageLifeTime(population):
  sum = 0
  for i in population:
    sum += i.life_time
...
def minFuc(n , score, averagePopulation):
  p = MinLT + round(n * (score/averagePopulation))
  return p

def life(popu):
  n = averageLifeTime(popu)
  avePopulation = avaregePopulation(popu)

  for cromo in popu:
    # print("Entrei aqui")
    res = minFuc(n,cromo.score, avePopulation)
    # print(type(res))
    cromo.life_time = min(res, MaxLT)
...
while count < 1:
  ...
  while True:
    ...
    list_more_adapted.append(POPULATION[0].score)
